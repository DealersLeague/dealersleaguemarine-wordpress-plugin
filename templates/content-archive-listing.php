...
<div class="section-title clearfix">
    ...
    <div class="float-left float-xs-none" style="display: flex;align-items: center;">
        ...
        <select name="sorting" id="sorting" class="width-200px" data-placeholder="<?php _e( 'Default Sorting', 'dlmarine');?>" >
            ...
            <option <?php echo $sort == 'date_asc' ? 'selected="selected"' : '' ; ?> value="<?php echo esc_url( add_query_arg( 'sort', 'date_asc' ) )?>"><?php _e( 'Newest First', 'dlmarine');?></option>
            <option <?php echo $sort == 'date_desc' ? 'selected="selected"' : '' ; ?> value="<?php echo esc_url( add_query_arg( 'sort', 'date_desc' ) )?>"><?php _e( 'Oldest First', 'dlmarine');?></option>
